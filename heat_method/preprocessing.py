...
def process_and_save(
    ...
    New keys added per split:
        - {split}_vx: (N, 1, H, W) X direction vectors
        - {split}_vy: (N, 1, H, W) Y direction vectors  
    ...
    for split_name, keys in splits.items():
        ...
        print(f"  Added: {split_name}_vx, {split_name}_vy, {split_name}_dist, {split_name}_reachable")
